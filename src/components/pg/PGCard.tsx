...
export default function PGCard({ pg }: PGCardProps) {
    ...
    return (
<<<<<<< HEAD:src/components/pg/PGCard.tsx
...
>>>>>>> 6b5cdb4 (Update frontend UI with SEO , content all over website on pager SEO):Soholiv_pg-main/src/components/pg/PGCard.tsx
